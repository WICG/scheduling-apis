...
<div algorithm>
  To <dfn lt="create a dependent task signal|creating a dependent task signal">create a dependent task singal</dfn>
  from a [=list=] of {{AbortSignal}} objects |signals| and a {{TaskSignalAnyInit}} |init|:
